...
class ProfileIcon extends StatefulWidget {
  ...
  const ProfileIcon({super.key, required this.onImagePicked, this.profileImage});
      ...
      children: [
        CircleAvatar(
          ...
          backgroundImage: widget.profileImage != null
              ...
              : const AssetImage('assets/images/add_a_photo.png') as ImageProvider, // Placeholder if no image
        ),
        Positioned(
          bottom: 0,
          right: 0,
